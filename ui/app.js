...
function init() {
    ...
    dz.on("complete", function (file) {
       ...
       var url = "http://127.0.0.1:5000/classify_image";  //for localhost
	 

       //var url = "/api/get_info";
        ...
        $.post(url, {
            ...
            */
            ...
            let players = ["Christopher Nolan", "Jordan Peterson", "Kiara advani", "Mahesh babu", "zKeanu Reeves"];
